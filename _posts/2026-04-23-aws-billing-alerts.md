...
3. 「予算を作成」をクリックし、予算タイプを選択ページを表示します。表示された予算タイプから、
...
2. 「予算を作成」をクリックし、予算タイプを選択ページを表示します。表示された予算タイプから、
*  予算の設定：カスタマイズ（アドバンスト）
*  予算タイプ：コスト予算
を選択し、「次へ」をクリックします。
...
を入力し、「アラートのしきい値を追加」をクリックし、以下のアラート2の設定も同様に入力します。
*  しきい値：予算額の100%
*  Eメールの受信者：アラートを通知するメールアドレス
...
## 5. この設定にかかる費用について {#cost}

ここが一番気になるポイントです。

結論から言うと、**今回の構成ならほぼ0円で運用できます。**
